...
export const chatan: City = {
    ...
    overview: {
        population: 30000,
        nearestBases: ["Kadena Air Base", "Camp Foster", "Camp Lester"],
        averageRent: 120000,
        commuteTimes: {
            "Kadena Air Base": 10,
            "Camp Foster": 15,
    ...
    highlights: [
        ...
        },
        {
            ...
            description: "Strategically located between major military bases with easy access to both northern and southern Okinawa.",
            icon: "location-dot"
        }
    ],
    neighborhoods: [
        {
            name: "Mihama District",
            description: "Home to American Village and numerous modern apartments. Very convenient for shopping and entertainment, with a vibrant nightlife.",
            bestFor: ["Young professionals", "Singles", "Couples without children"],
            priceRange: "¥120,000 - ¥180,000"
        },
        {
            name: "Araha Area",
            description: "Quiet residential area near Araha Beach, perfect for families. Many housing options with ocean views.",
            bestFor: ["Families", "Beach lovers", "Those seeking a quieter lifestyle"],
            priceRange: "¥130,000 - ¥200,000"
        },
        {
            name: "Kitamae",
            description: "Traditional Japanese neighborhood with a mix of old and new housing. Close to local schools and markets.",
            bestFor: ["Cultural immersion seekers", "Budget-conscious renters"],
            priceRange: "¥90,000 - ¥140,000"
        }
    ],
    amenities: {
        schools: {
