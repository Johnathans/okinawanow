          ...
          <div className={`collapse navbar-collapse ${isMobileMenuOpen ? 'show' : ''}`} style={{ position: 'static' }}>
            <ul className="navbar-nav ms-auto">
              <li className="nav-item dropdown" style={{ position: 'static' }}>
                <Link 
                  href="/properties" 
                  className={`nav-link dropdown-toggle ${pathname === '/properties' ? 'active fw-bold' : ''}`}
                  role="button"
                    ...
                    <div className="row g-4">
                      <div className="col-lg-4">
                        ...
                        <div className="d-flex flex-column gap-2">
                          ...
                          <Link href="/properties?type=mansion" className="text-decoration-none text-muted">
                      ...
                      <div className="col-lg-4">
                        ...
                        <div className="d-flex flex-column gap-2">
                          <Link href="/properties?area=kadena" className="text-decoration-none text-muted">
                            <FontAwesomeIcon icon={faLocationDot} className="me-2" />
                            Kadena
                          </Link>
                          <Link href="/properties?area=foster" className="text-decoration-none text-muted">
                            <FontAwesomeIcon icon={faLocationDot} className="me-2" />
                            Foster
                          </Link>
                          <Link href="/properties?area=american_village" className="text-decoration-none text-muted">
                            <FontAwesomeIcon icon={faLocationDot} className="me-2" />
                            American Village
                          </Link>
                        </div>
                      ...
                      <div className="col-lg-4">
                        ...
                        <div className="d-flex flex-column gap-2">
                          <Link href="/properties/search" className="text-decoration-none text-muted">
                            <FontAwesomeIcon icon={faSearch} className="me-2" />
                            Advanced Search
                          </Link>
                          <Link href="/properties/featured" className="text-decoration-none text-muted">
