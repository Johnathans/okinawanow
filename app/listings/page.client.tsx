  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        const validPropertyIds = new Set(propertiesSnap.docs.map(doc => doc.id));

        // Filter out listings without valid properties
        const validListings = listingsData.filter(listing => validPropertyIds.has(listing.propertyId));
    ...
    <div className="container-fluid px-4">
      ...
      <div className="row mb-4">
        <div className="col-12">
          <ListingsFilterBar searchParams={searchParams} />
        </div>
      </div>
